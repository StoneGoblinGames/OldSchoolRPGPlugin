...
#include "OldSchoolRPGTables.generated.h"

DECLARE_LOG_CATEGORY_EXTERN(LogOldSchoolRPGTables, Log, All);

/**
 * 
 */
UCLASS(Blueprintable)
class OLDSCHOOLRPG_API UOldSchoolRPGTables final : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
